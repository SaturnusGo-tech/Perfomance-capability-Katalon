...
archiveUrl = 'https://omniablob.blob.core.windows.net/autotests/qwetheme_test_x.zip'
uploadFileUrlLocal = WS.sendRequestAndVerify(findTestObject('Object Repository/API/backWebServices/VirtoCommerce.Content/ContentFileNewUrl', [
