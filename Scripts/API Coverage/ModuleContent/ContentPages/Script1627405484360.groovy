...
fileUrl = 'https://omniablob.blob.core.windows.net/autotests/qwepage.en-US.md'
uploadFileUrlLocal = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Content/ContentFileNewUrl', [
	('contentType') : GlobalVariable.contentType,
	('storeId') : GlobalVariable.storeId,
	('fileUrl') : fileUrl,
	('folderName') : GlobalVariable.folderName
