...
fileUrl = 'https://omniablob.blob.core.windows.net/autotests/forbidden.exe'
...
for (String contentType : contentTypes.keySet()) {
	upload = WS.sendRequest(findTestObject('Object Repository/API/backWebServices/VirtoCommerce.Content/ContentFileNewUrl', [
