...
'VERIFY THE FOLDER HAS BEEN CREATED AND GET FOLDER URL' //Should I remove this for the sake of having 
...
GlobalVariable.folderUrl = WS.getElementPropertyValue(verifyCreated,'results[0].url')
