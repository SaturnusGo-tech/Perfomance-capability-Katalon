...
initialIndexation = WS.callTestCase(findTestCase('Test Cases/API Coverage/ModuleSearch/GetIndex'),
	null)
documentType = WS.getElementPropertyValue(initialIndexation, '[1].documentType')
initialDate = WS.getElementPropertyValue(initialIndexation, '[1].lastIndexationDate')


'GET THE INITIAL INDEXATION DATE FOR THE CATEGORY'
categoryInitialIndexationGet = WS.callTestCase(findTestCase('Test Cases/API Coverage/_OPUS/_OPUS_CustomerPortal/OPUS_ModuleSearch/OPUS_GetIndexForCategory'),
	null)
categoryInitalDate = WS.getElementPropertyValue(categoryInitialIndexationGet, '[0].indexationdate')
...
updatedIndexation = WS.callTestCase(findTestCase('Test Cases/API Coverage/ModuleSearch/GetIndex'),
	null)
updatedDocumentType = WS.getElementPropertyValue(updatedIndexation, '[1].documentType')
updatedDate = WS.getElementPropertyValue(updatedIndexation, '[1].lastIndexationDate')


'GET THE UPDATED INDEXATION DATE FOR THE CATEGORY'
categoryUpdatedIndexationGet = WS.callTestCase(findTestCase('Test Cases/API Coverage/_OPUS/_OPUS_CustomerPortal/OPUS_ModuleSearch/OPUS_GetIndexForCategory'),
	null)
categoryUpdatedDate = WS.getElementPropertyValue(categoryUpdatedIndexationGet, '[0].indexationdate')


'VERIFY THE DATA WAS UPDATED'
assert documentType == updatedDocumentType
assert initialDate < updatedDate
assert categoryInitalDate < categoryUpdatedDate
